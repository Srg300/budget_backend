    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.CharField(blank=True, max_length=8, verbose_name='Код')),
                ('name', models.TextField(max_length=2000, verbose_name='Полное наименование')),
                ('startdate', models.DateTimeField(default=datetime.datetime.now, verbose_name='')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('budget', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='budget.Budget', verbose_name='Бюджет')),
            ],
            options={
